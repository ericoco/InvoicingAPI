...
export class PostCustomerInvitation extends Construct {
  handler: NodejsFunction;

  constructor(scope: Construct) {
    super(scope, PostCustomerInvitation.name);
    this.handler = new NodejsFunction(this, 'function', {
      entry: path.join(__dirname, '../../../src/handlers/invitations/post-customer-invitation.function.ts')
    });
